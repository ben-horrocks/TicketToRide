...
public class GameModel
{
	...
	public void addTrainToOpponent(int number) { getOpponents().get(0).addHandCard(number); }

	// TODO: update to get correct opponent
	public void removeTrainFromOpponent(int number) { getOpponents().get(0).removeHandCard(number); }

	// TODO: update to get correct opponent
	public void addDestToOpponent(int number) { getOpponents().get(0).addDestinationCards(number); }

	// TODO: update to get correct opponent
	public void removeDestFromOpponent(int number) { getOpponents().get(0).removeDestinationCard(number); }
	...
	public void updateChat(ChatItem item) { gameData.addChatMessage(item); }
	...
	public void updateHistory(HistoryItem item) { gameData.addHistoryItem(item); }
	...
	public void addPoints(int number) { getPlayer().addPoints(number); }
}

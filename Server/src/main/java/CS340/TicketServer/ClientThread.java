...
public class ClientThread extends Thread
{
    ...
    private Signal getSignalFromClient()
    {
        return signalFromClient;
    }

    private void setSignalFromClient(Signal signalFromClient)
    {
        this.signalFromClient = signalFromClient;
    }
